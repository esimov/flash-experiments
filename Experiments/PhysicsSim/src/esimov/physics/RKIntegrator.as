package esimov.physics
{
	...
	public class RKIntegrator implements Integrator
	{
		...
		private var k1VelInt:Vector3D = new Vector3D;
		private var k2VelInt:Vector3D = new Vector3D;
		private var k3VelInt:Vector3D = new Vector3D;
		private var k4VelInt:Vector3D = new Vector3D;
		private var k1ForceInt:Vector3D = new Vector3D;
		private var k2ForceInt:Vector3D = new Vector3D;
		private var k3ForceInt:Vector3D = new Vector3D;
		private var k4ForceInt:Vector3D = new Vector3D;
		private var k1Vel:Vector3D = new Vector3D;
		private var k2Vel:Vector3D = new Vector3D;
		private var k3Vel:Vector3D = new Vector3D;
		private var k4Vel:Vector3D = new Vector3D;
		private var k1Force:Vector3D = new Vector3D;
		private var k2Force:Vector3D = new Vector3D;
		private var k3Force:Vector3D = new Vector3D;
		private var k4Force:Vector3D = new Vector3D;
