package  
{
	...
	import com.esimov.geom.Point3D;

	[SWF(backgroundColor = '0x00', width = '600', height = '600', frameRate=60)]

	/**
	 * @author simoe
	 */
	public class TuringPatternAL extends Sprite
	{
		...
		public function TuringPatternAL():void
		{
			if (stage)
			{
				initStage(null);
